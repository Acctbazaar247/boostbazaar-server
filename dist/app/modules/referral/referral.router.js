...
router.get('/', (0, auth_1.default)(client_1.UserRole.admin, client_1.UserRole.user), referral_controller_1.ReferralController.getAllReferral);
router.get('/:id', referral_controller_1.ReferralController.getSingleReferral);
router.post('/send-invitation', (0, auth_1.default)(client_1.UserRole.admin, client_1.UserRole.user), (0, validateRequest_1.default)(referral_validation_1.ReferralValidation.invitation), referral_controller_1.ReferralController.sendReferralEmail);
// router.patch(
//   '/:id',
