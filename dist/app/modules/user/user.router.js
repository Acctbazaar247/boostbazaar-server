...
router.get('/:id', (0, auth_1.default)(client_1.UserRole.admin, client_1.UserRole.seller, client_1.UserRole.user, client_1.UserRole.ccAdmin, client_1.UserRole.financeAdmin), user_controller_1.UserController.getSingleUser);
router.patch('/:id', (0, auth_1.default)(client_1.UserRole.admin, client_1.UserRole.user, client_1.UserRole.seller, client_1.UserRole.superAdmin, client_1.UserRole.ccAdmin, client_1.UserRole.financeAdmin), (0, validateRequest_1.default)(user_validation_1.UserValidation.updateValidation), user_controller_1.UserController.updateUser);
router.delete('/:id', (0, auth_1.default)(client_1.UserRole.superAdmin, client_1.UserRole.ccAdmin, client_1.UserRole.financeAdmin), user_controller_1.UserController.deleteUser);
